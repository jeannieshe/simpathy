...
# define nodes of dialogues
default_state = Node(
    name="Default State",
    description=(
        "This is the opening screen of the dialogue. Every session starts in "
...
# define class ChitChatDialogue and rules
